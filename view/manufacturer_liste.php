        ...
        if(is_array($result)){
            foreach($result as $r){
                ...
                echo "<p>
                    ...
                    <a href='index.php?p=".$url_page."&manufacturer_id=".$id."&action=update&alpha=".$get_alpha."&id=".$get_id."' title='Editer cette entrée' class='bt-action'><i class=\"far fa-edit\"></i></a> 
