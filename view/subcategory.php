    ...
    <div id='search' class='u-full-width'>
        <div id="trail" class="container row">
            <ul>
                ...
                <li><a href="index.php?p=category&id=<?= $category_id ?>" title="<?= $category ?>"><?= $category ?></a></li>
                <li><?= $subcategory ?></li>
            </ul>
        </div>
    </div>
    ...
    <section class="container">
        <div class="row">
            <nav class="three columns">
                <ul id="accordion">
                    ...
                    foreach($result_subcategory_sorted as $r) {
                        $category_subcategory_id = $r['id'];
                        $category_subcategory = $r['subcategory'];
                        $class = $category_subcategory_id == strval($_GET['id']) ? ' style="background-color:#AAD5DF;color:white;"' : "";
                        echo '<li><a '.$class.' href="index.php?p=subcategory&id='.$category_subcategory_id.'">'.$category_subcategory.'</a></li>';
                    }
                    ?>
                </ul>
            </nav>
            ...
            if(!empty($result_ad_sorted)) {
                ...
                if ($pageActuelle > 1) {
                    echo '<li><a href="index.php?p=subcategory&id='.$subcategory_id.'&page=1">|<<</a></li>';
                    echo '<li><a href="index.php?p=subcategory&id='.$subcategory_id.'&page=' . ($pageActuelle - 1) . '"><</a></li>';
                    echo '<li>...</li>';
                }
                // 3 pages précedentes 
                for ($page = max(1, $pageActuelle - $pagesAvant); $page < $pageActuelle; $page++) {
                    echo '<li><a href="index.php?p=subcategory&id='.$subcategory_id.'&page=' . $page . '">' . $page . '</a></li>';
                }
                // page actuelle
                echo '<li><a href="index.php?p=subcategory&id='.$subcategory_id.'&page=' . $page . '" class="active">' . $page . '</a></li>';
                // 10 pages après
                ...
                if ($pageActuelle < $totalPages) {
                    echo "<li>...</li>";
                    echo '<li><a href="index.php?p=subcategory&id='.$subcategory_id.'&page=' . ($pageActuelle + 1) . '">></a></li>';
                    echo '<li><a href="index.php?p=subcategory&id='.$subcategory_id.'&page=' . $totalPages . '">>>|</a></li>';
                }
                echo '</ul>';
            }
            ?>
