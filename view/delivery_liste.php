    ...
    <div class="six columns">
        ...
        if(is_array($result)){
            foreach($result as $r){
                ...
                echo "<p>
                    <a href='index.php?p=".$url_page."&delivery_id=".$id."&action=update' title='Editer cette entrée' class='bt-action'><i class=\"far fa-edit\"></i></a> 
                    <a href='index.php?p=".$url_page."&delivery_id=".$id."&action=showHide' title='".$txt_title."' class='bt-action'>".$txt_visible."</a> 
                    ".$txt_nom." 
                </p>";
            }
        }else{
